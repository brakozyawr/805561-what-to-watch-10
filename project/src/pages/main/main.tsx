import FilmCards from 'src/components/film-card/film-card';
import {Film} from 'src/types/types';


const filmCardsData:Film[] = [
  {
...
const Main = ({title, genre, year}:Props): JSX.Element => (
  <>
    ...
    <div className="page-content">
      <section className="catalog">
        ...
        <div className="catalog__films-list">
          {<FilmCards films={filmCardsData} /> }
          {/*filmCardsData.map((film:Film) => <FilmCard key={film.title} film={film} />)*/}
        </div>
